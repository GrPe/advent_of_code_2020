namespace Day7
{
    static class Input
    {
        public static string test = @"light red bags contain 1 bright white bag, 2 muted yellow bags.
...
";
        ...
        public static string test2 = @"shiny gold bags contain 2 dark red bags.
...
dark violet bags contain no other bags.";
        ...
        public static string data = @"posh teal bags contain 2 faded coral bags, 3 striped crimson bags, 1 faded red bag.
